...
AppRuntime::AppRuntime(LibXR::HardwareContainer &hardware,
    ...
    : // --- Topic 基础设施 ---
      ...
      bmi088_(hardware, application_manager,
              ...
              AppConfig::kBmi088AcclTopicName, 45.0f, 2048),
      ...
      secondary_remote_control_(
          MakeOptionalSecondaryRemote(hardware,
                                                   application_manager)),
